<template>
  <div class="home">
    <div class="main">
      <div class="main-left">
           <div class="spin"><img src="../assets/usi-tech.png" alt="" width="500px" class="usi-tech" ></div>
            <img src="../assets/usi-face.jpg" alt="" class="usi-face" width="200px">
      </div>
      <div class="text">
        ...
        <div>A self trained web developer with 2+ years experience in fullstack web development, with core interest in building innovative projects for corporations, startups and individuals.</div>
        <br>
